...
inertial_poser = TransPoseNet1StageSRU(num_past_frame=20, num_future_frame=5, isMatrix=False, device=device).to(device)
# inertial_poser = TransPoseNet(num_past_frame=20, num_future_frame=5).to(device)
inertial_poser.load_state_dict(torch.load("结果/best/checkpoint_fineturning_1980.tar")['state_dict'])
